...
export const Route = createFileRoute("/facilities")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sarana dan prasarana penunjang pembelajaran di SD Cendekia Harapan." },
    ],
  }),
...
function Facilities() {
  return (
    <>
      <PageHeader title="Fasilitas" subtitle="Lingkungan belajar yang aman, modern, dan menginspirasi." />
